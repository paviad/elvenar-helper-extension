...
- Everything arriving over the game's websocket was being read once for every listener the game had registered on it — five times over, in practice — and so processed and written to storage five times for one event. Once each now. Nothing was wrong with what it stored, since chat already discards what it has seen and a wonder's total is sent as a total rather than an increment; it was simply doing all of it five times.
