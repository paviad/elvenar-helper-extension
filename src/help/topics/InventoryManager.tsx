...
export const InventoryManager = () => (
  <Box>
    <Typography variant="h4" gutterBottom>Inventory Manager Guide</Typography>
    <Typography paragraph>
      The Inventory Manager transforms your cluttered inventory into a powerful, searchable database. 
      It helps you make informed decisions about what to place, what to keep, and what to disenchant.
    </Typography>
