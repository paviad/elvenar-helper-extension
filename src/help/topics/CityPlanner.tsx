...
export const CityPlanner = () => (
  <Box>
    <Typography variant="h4" gutterBottom>City Planner Guide</Typography>
    <Typography paragraph>
      The City Planner is the core of ElvenAssist, allowing you to manipulate your city layout with live data. 
      Below is a detailed guide to its capabilities.
    </Typography>
