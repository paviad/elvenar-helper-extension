...
export const HELPER_MESSAGES: Record<HelperMessageId, string> = {
  drag_tip:
    "While dragging, you can press the '+' and '-' keys to quickly change the building's level (or its stage when pressing Shift as well). You may also press 'Del' to delete it.",
