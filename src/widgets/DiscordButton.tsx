...
export const DiscordButton: React.FC<DiscordButtonProps> = ({ discordUrl, sx, ...props }) => {
  return (
    <Tooltip title='Join our Discord Community'>
      <IconButton
        component='a'
        href={discordUrl}
        target='_blank'
        ...
        sx={{
          ...
          '&:hover': {
            backgroundColor: 'rgba(88, 101, 242, 0.08)', // Subtle blurple hover state
          },
          ...sx,
        }}
        {...props}
